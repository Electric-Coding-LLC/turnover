...
- The app has a clear layered architecture that can guide implementation and
  the data model.
- HealthKit, storage, and calculation boundaries are explicit enough to prevent
  UI-layer leakage and scope creep.
