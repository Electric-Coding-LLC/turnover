...
- the app already has stored data and is refreshing in the background or from a
  refresh trigger such as app open or returning to the foreground
...
- The app's required loading, empty, permission, error, and save states are
  explicit enough to guide design and implementation.
- Recovery behavior stays lightweight and in-context instead of expanding into
  extra flows or screens.
